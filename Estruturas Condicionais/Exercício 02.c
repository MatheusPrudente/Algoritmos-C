...
Escreva um programa em C que leia o número de litros vendidos, 
o tipo de combustível (codificado da seguinte forma: “A” para álcool e “G” para gasolina), 
calcule e imprima o valor a ser pago 
pelo cliente sabendo-se que o preço do litro da gasolina é R$ 4,30 o preço do litro do álcool é R$ 3,20.*/
#include "stdio.h"
#include "math.h"
int main() {
