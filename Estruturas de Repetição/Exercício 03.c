...
/*Faça um programa que apresente o menu de opções a seguir realizando o que cada opção representa:

Menu de opções:

1.    Média aritmética de N números.

2.    Média ponderada de N números.

3.    Sair.

Digite a opção desejada:

Note que o programa ficará em um looping, repetindo: a impressão do menu, capturando a opção do usuário e executando a operação desejada.
