/*Dizemos que uma matriz quadrada é um quadrado mágico 
se a soma dos elementos de cada linha, a soma dos elementos 
de cada coluna e a soma dos elementos das diagonais principal 
e secundária são todas iguais. Faça um programa que, dado uma matriz quadrada, 
informe se esta matriz é ou não um quadrado mágico. 
Note que, o termo “matriz quadrada” se refere a matrizes que possuem o mesmo número de linhas e colunas (Ex.: 3x3, 4x4, 5x5, etc..).*/
